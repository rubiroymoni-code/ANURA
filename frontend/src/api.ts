...
export const nutritionApi = {
  ...
  mealOptions:(id:string)=>request<MealOption[]>(`/nutrition/today/${id}/options`),
  selectMealOption:(id:string,optionCode:string,date:string)=>request<void>(`/nutrition/today/${id}/option`,{method:"POST",body:JSON.stringify({optionCode,date})}),
