...
public class WorkoutExecutionController {
 ...
 @PostMapping("/api/v1/workout-sessions/{id}/exercises/{exerciseId}/activity") ExerciseView activity(@PathVariable UUID id,@PathVariable UUID exerciseId,@RequestBody ActivityRequest r){ExerciseView activity=service.recordActivity(id,exerciseId,r);service.complete(id,new CompleteRequest(null,null,null,null,null,"Sesión completada con actividad registrada.",null));return activity;}
