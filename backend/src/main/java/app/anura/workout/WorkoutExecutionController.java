...
public class WorkoutExecutionController {
 ...
 @PostMapping("/api/v1/workout-sessions/{id}/exercises/{exerciseId}/activity") ExerciseView activity(@PathVariable UUID id,@PathVariable UUID exerciseId,@RequestBody ActivityRequest r){return service.recordActivity(id,exerciseId,r);}
