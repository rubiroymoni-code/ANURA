...
public class ProfileController {
    ...
    java.util.Map<String,Object> preferences(){return db.queryForList("SELECT primary_goal,experience_level,activity_level,height_cm,training_days,limitations,reminder_email_enabled,reminder_frequency,last_summary_sent_at FROM user_preference WHERE user_id=?",CurrentUser.id()).stream().findFirst().orElse(java.util.Map.of("reminder_email_enabled",true,"reminder_frequency","MONTHLY"));}
