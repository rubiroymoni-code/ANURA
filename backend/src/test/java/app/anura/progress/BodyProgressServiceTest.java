...
class BodyProgressServiceTest {
    ...
    @Test void requiresDateAndWeight(){var r=new BodyProgressService.CheckinRequest(null,null,null,null,null,null,null,null,null,null,null,null);assertThrows(ApiException.class,()->service.validate(r));}

    private BodyProgressService.CheckinRequest request(String weight,String waist){return new BodyProgressService.CheckinRequest(LocalDate.of(2026,7,26),new BigDecimal(weight),new BigDecimal("18"),new BigDecimal(waist),new BigDecimal("100"),new BigDecimal("95"),new BigDecimal("35"),new BigDecimal("35.5"),new BigDecimal("57"),new BigDecimal("57.5"),"Seguimiento semanal");}
}
