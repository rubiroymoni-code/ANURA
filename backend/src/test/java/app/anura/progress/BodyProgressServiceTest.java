...
class BodyProgressServiceTest {
    ...
    @Test void requiresDateAndWeight(){var r=new BodyProgressService.CheckinRequest(null,null,null,null,null,null,null,null,null,null,null);assertThrows(ApiException.class,()->service.validate(r));}
